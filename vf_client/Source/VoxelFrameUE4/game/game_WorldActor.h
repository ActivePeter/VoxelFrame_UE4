...
public:
	//bpe blue print event
	UPROPERTY(BlueprintAssignable, Category = "UIRecvEvent")
		FTextureUpdateDeleg bpe_texture_update;

	//bpv blue print value
	UPROPERTY(BlueprintReadWrite, Category = "UIValue")
		UTexture2D* bpv_texture_rendered = nullptr;
